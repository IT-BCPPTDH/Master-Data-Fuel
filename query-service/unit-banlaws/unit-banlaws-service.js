...
const editUnitBanlaws = async (updateFields) => {
    try {
        ...
        const query = `UPDATE master_unit_banlaws SET ${setClauses} WHERE id = $${values.length}`;
